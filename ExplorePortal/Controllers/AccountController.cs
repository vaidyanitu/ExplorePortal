...
namespace ExplorePortal.Controllers
{
    ...
    public class AccountController : Controller
    {
        public AccountController()
            : this(new UserManager<ApplicationUser>(new UserStore<ApplicationUser>(new ExploreDbContext())))
        {
        }
        ...
        public async Task<ActionResult> Register(RegisterViewModel model)
        {
            ...
            " title=\"User Email Confirm\">{1}</a>",user.UserName,Url.Action("ConfirmEmail","Account",new{Token=user.Id, Email=user.Email},Request.Url.Scheme));
                    m.IsBodyHtml = true;
                 ...
                 //   smtp.ServerCertificateValidationCallback = () => true; //Solution for client certificate error                    await SignInAsync(user, isPersistent: false);
